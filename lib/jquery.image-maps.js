    ...
    jQuery.fn.imageMaps = function(setting) {
		...
		$container.each(function(){
			...
			$images.each(function(){
				...
				// 添加按钮
				_img_conrainer.append('<div class="button-conrainer"><input type="button" value="添加锚点" /></div>').append('<div class="link-conrainer"></div>').append($.browser.msie ? $('<div class="position-conrainer" style="position:absolute"></div>').css({
					background:'#fff',
					opacity:0
		...
		//绑定map事件
		window.bind_map_event = function(){
